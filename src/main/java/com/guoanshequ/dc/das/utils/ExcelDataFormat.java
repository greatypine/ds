...
public class ExcelDataFormat {
     ...
     * @return
     */
   /* public static Map<String, Object> getMapDataFromExcel(InputStream inputStream) throws Exception {
        return getMapDataFromExcel(inputStream);
    }*/
     ...
     * @return
     */
    public static Map<String, Object> getMapDataFromExcel(InputStream inputStream) {
