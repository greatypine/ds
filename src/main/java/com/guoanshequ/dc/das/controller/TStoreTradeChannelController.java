...
@RestController
@ResponseBody
public class TStoreTradeChannelController {
    ...
    @RequestMapping(value = "rest/queryTStoreTradeChannel",method = RequestMethod.POST)
    public RestResponse queryTStoreTradeChannel(@RequestBody Map<String, String> paraMap) throws Exception {
    	try{
