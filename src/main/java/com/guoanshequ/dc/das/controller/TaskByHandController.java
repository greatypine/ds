...
//            massOrderScheduleTask.customerTradeTask();
    ...
    @RequestMapping(value = "rest/testImpalaTaskRun",method = RequestMethod.POST)
    public RestResponse testImpalaTask(@RequestBody Map<String, String> paraMap) throws Exception {
    	try{
    		testTask.testImpala();
    		return new RestResponse(EnumRespStatus.TASK_RUNOK);
    	}catch (Exception e) {
